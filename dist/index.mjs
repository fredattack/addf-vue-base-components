    ...
    ($props.editionMode)
      ? (openBlock(), createElementBlock("div", {
          ...
          withDirectives((openBlock(), createElementBlock("input", {
            ...
            id: $props.name,
            class: normalizeClass([ $options.internalValueIsAFullDate ? 'focus:border-green-400 focus:ring-green-400' : 'focus:border-red-500 focus:ring-red-500', 'border-gray-400 focus:ring-1', $options.cInputClass]),
            placeholder: $props.placeholder
