...
var script$1p = {
  ...
  components: { multiselect, BaseShowLabel: script$1r, BaseEditLabel: script$1q},
  props: {
    editionMode: {
      type: Boolean,
      default: true,
...
var script$P = {
  ...
  components: { multiselect, BaseEditLabel: script$1q},
  props: {
    name: {
      type: String,
      required: true
        ...
        Mention.configure({
          ...
          suggestion: {
            ...
            render: () => {
              ...
              return {
                onStart: (props) => {
                  component = new VueRenderer(script$l, {
                    props,
                    editor: props.editor,
                  });
                  popup = tippy("body", {
