...
var script$1r = {
  ...
  components: { multiselect, BaseShowLabel: script$1t, BaseEditLabel: script$1s},
  props: {
    editionMode: {
      type: Boolean,
      default: true,
...
var script$R = {
  ...
  components: { multiselect, BaseEditLabel: script$1s},
  props: {
    name: {
      type: String,
      required: true
        ...
        Mention.configure({
          ...
          suggestion: {
            ...
            render: () => {
              ...
              return {
                onStart: (props) => {
                  component = new VueRenderer(script$n, {
                    props,
                    editor: props.editor,
                  });
                  popup = tippy("body", {
