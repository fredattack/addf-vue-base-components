  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    ...
    ($data.showActivity)
      ? (openBlock(), createElementBlock("tr", {
          ...
          createElementVNode("td", _hoisted_1$1c, [
...
var script$1o = {
  ...
  components: { multiselect, BaseShowLabel: script$1q, BaseEditLabel: script$1p},
  props: {
    editionMode: {
      type: Boolean,
      default: true,
...
function render$1n(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock(Fragment, null, [
    (openBlock(), createElementBlock("div", {
      ...
      ($props.label)
        ? (openBlock(), createElementBlock("label", _hoisted_1$17, [
            createTextVNode(toDisplayString($props.label) + " ", 1 /* TEXT */),
...
function render$1l(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("button", {
    ...
    ($props.icon)
      ...
      : createCommentVNode("v-if", true),
    ($props.title)
      ? (openBlock(), createElementBlock("span", _hoisted_1$15, toDisplayString($props.title), 1 /* TEXT */))
      : createCommentVNode("v-if", true)
  ], 2 /* CLASS */))
}
...
const _hoisted_1$13 = { class: "box lg:mt-5" };
const _hoisted_2$W = {
  key: 0,
...
function render$1i(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("section", null, [
    (_ctx.$slots.sectionTitle || ( $props.sectionTitle && $props.sectionTitle.length))
      ? (openBlock(), createElementBlock("header", _hoisted_1$12, [
...
function render$17(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (!$props.big)
    ? (openBlock(), createElementBlock("span", _hoisted_1$U, [
...
function render$11(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("h2", _hoisted_1$P, [
    renderSlot(_ctx.$slots, "default")
  ]))
}
...
const _hoisted_1$N = /*#__PURE__*/createTextVNode(" Server size ");
...
const _hoisted_1$L = { class: "flex flex-col" };
const _hoisted_2$F = {
  key: 0,
...
const _hoisted_1$I = ["name", "value", "id", "placeholder"];
const _hoisted_2$D = {
  key: 1,
  class: "mt-3"
};
  ...
  return ($props.editionMode)
    ? (openBlock(), createElementBlock("div", {
        ...
        withDirectives(createElementVNode("input", {
          ...
          class: normalizeClass([$options.cInputClass, "border-gray-400 focus:border-blue-300 focus:ring-blue-300 focus:ring-1"]),
          placeholder: $props.placeholder
        }, null, 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_1$I), [
          [_directive_mask, $props.mask]
        ]),
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.errors, (error, index) => {
          return (openBlock(), createElementBlock("div", {
...
const _hoisted_1$F = ["id", "name", "value", "checked"];
...
var script$O = {
  ...
  components: { multiselect, BaseEditLabel: script$1p},
  props: {
    name: {
      type: String,
      required: true
  ...
  return ($props.editionMode)
    ? (openBlock(), createElementBlock("div", {
        ...
        withDirectives(createElementVNode("input", {
          ...
          class: normalizeClass([$options.cInputClass, "border-gray-400 focus:border-blue-300 focus:ring-blue-300 focus:ring-1"]),
          placeholder: $props.placeholder
        }, null, 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_1$z), [
          [_directive_mask, $props.mask]
        ]),
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.errors, (error, index) => {
          return (openBlock(), createElementBlock("div", {
...
const _hoisted_1$y = { class: "mt-1.5 flex place-items-center" };
...
const _hoisted_1$x = { class: "box px-6 py-5" };
...
const _hoisted_1$t = ["id", "name", "value", "checked"];
...
const _hoisted_1$r = { class: "block" };
...
const _hoisted_1$p = { class: "flex flex-col mt-2" };
...
const _hoisted_2$i = /*#__PURE__*/createElementVNode("span", null, "shit", -1 /* HOISTED */);

function render$t(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock(Fragment, null, [
    createElementVNode("span", { innerHTML: $options.cellValue }, null, 8 /* PROPS */, _hoisted_1$k),
    _hoisted_2$i
  ], 64 /* STABLE_FRAGMENT */))
}
...
const _hoisted_2$h = { class: "flex justify-center gap-x-3" };
const _hoisted_3$c = {
  key: 0,
...
const _hoisted_2$g = /*#__PURE__*/createElementVNode("i", { "data-feather": "hard-drive" }, null, -1 /* HOISTED */);
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1$g, [
    ($props.items.length)
      ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList($props.items, (item, index) => {
          ...
          }, toDisplayString(item), 11 /* TEXT, CLASS, PROPS */, _hoisted_2$f))
        }), 128 /* KEYED_FRAGMENT */))
        ...
        Mention.configure({
          ...
          suggestion: {
            ...
            render: () => {
              ...
              return {
                onStart: (props) => {
                  component = new VueRenderer(script$k, {
                    props,
                    editor: props.editor,
                  });
                  popup = tippy("body", {
...
const _hoisted_2$d = { class: "px-1 py-1" };
        ...
        createVNode(_component_MenuButton, {
          ...
          default: withCtx(() => [
            ($props.icon !== null)
              ...
              : createCommentVNode("v-if", true),
            ($props.with_label)
              ? (openBlock(), createElementBlock("span", _hoisted_1$e, toDisplayString($options.cCurentStatut && $options.cCurentStatut[$props.label]), 1 /* TEXT */))
              : createCommentVNode("v-if", true),
...
const _hoisted_1$d = { class: "px-1 py-1" };
...
const _hoisted_1$9 = { class: "mt-1 flex rounded-md shadow-sm" };
const _hoisted_2$9 = { class: "relative flex items-stretch flex-grow focus-within:z-10" };
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("fieldset", null, [
    ($props.editionMode)
      ? (openBlock(), createElementBlock("legend", _hoisted_1$8, toDisplayString($props.legend), 1 /* TEXT */))
      : createCommentVNode("v-if", true),
...
const _hoisted_2$6 = { class: "form-check mr-4 sm:mt-0" };
...
const _hoisted_1$5 = { class: "mt-5 space-y-3" };
      ...
      ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createElementVNode("div", _hoisted_1$4, [
            ...
            ($props.displayTimeDifference && $options.timeDifference)
              ? (openBlock(), createElementBlock("div", _hoisted_2$4, " ( " + toDisplayString($options.timeDifference) + " ) ", 1 /* TEXT */))
              : createCommentVNode("v-if", true)
          ]),
